    ...
    <section id={pricing.name} className='py-16'>
      <div className='container'>
        <div className='mx-auto mb-12 text-center'>
          <h2 className='mb-4 text-3xl font-semibold lg:text-4xl'>{pricing.title}</h2>
              ...
              return (
                <div
                  ...
                  className={`rounded-lg p-6 ${
                    item.is_featured ? "border-primary border-2 bg-card text-card-foreground" : "border-muted border"
                  }`}
                >
                  <div className='flex h-full flex-col justify-between gap-5'>
                    <div>
                      ...
                      {item.features_title && <p className='mb-3 mt-6 font-semibold'>{item.features_title}</p>}
                      {item.features && (
